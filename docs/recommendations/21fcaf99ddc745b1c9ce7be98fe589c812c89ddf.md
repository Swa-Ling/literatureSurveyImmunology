...
<body>
  <p>
  <i class="footer">This page was last updated on 2025-09-15 09:15:23 UTC</i>
  </p>
  ...
  <tbody>
        ...
        <tr id="In Alzheimer’s disease (AD), specific brain regions become vulnerable to pathology while others remain resilient. New methods of imaging such as highly multiplexed immunofluorescence (MxIF) provide an abundance of spatial information, while analytical techniques like machine learning (ML) can address questions of cellular contributors to this regional vulnerability.">
          <td id="tag"><i class="material-icons">visibility_off</i></td>
          <td><a href="https://www.semanticscholar.org/paper/f661168de6c8530f41d73a876647de7773ee3b98" target='_blank'>Comparing methods of cellular segmentation in prefrontal and primary visual cortices in Alzheimer’s disease</a></td>
          <td>
